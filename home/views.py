...
def home(request):
    data_image_of_day = requests.get('https://api.nasa.gov/planetary/apod?api_key=6hVDb2jPeReiVcvyBnWw9hEJENg1E4FSQheSmxxp').json()

    data_news = requests.get('https://api.spaceflightnewsapi.net/v3/articles').json()

    data_people = requests.get('http://api.open-notify.org/astros.json').json()
    data_people = data_people['people']
    
    return render(request, "home/index.html", {"data_image_of_day": data_image_of_day, "data_news": data_news, "data_people": data_people})

def simulation(request):
    return render(request, "home/simulation.html")
...
def contact(request):
    if request.POST:
        ...
        create_obj = Order.objects.create(
...
def gallery(request):
    mars_image = requests.get('https://api.nasa.gov/planetary/apod?api_key=6hVDb2jPeReiVcvyBnWw9hEJENg1E4FSQheSmxxp&count=100').json()
    return render(request, "home/gallery.html", {"mars_image": mars_image})
...
def api(request):
    ...
    "hdurl": "https://apod.nasa.gov/apod/image/0708/B-Mira-Head.jpg",
    "media_type": "image",
    "service_version": "v1",
    "title": "The Tail of a Wonderful Star",
    "url": "https://apod.nasa.gov/apod/image/0708/B-Mira-Headc720.jpg"
    },
    {
    "copyright": "Alan Dyer",
    "date": "2017-10-14",
    ...
    "hdurl": "https://apod.nasa.gov/apod/image/1710/SteveAuroralArc_allskyproj.jpg",
    "media_type": "image",
    "service_version": "v1",
    "title": "All-Sky Steve",
    "url": "https://apod.nasa.gov/apod/image/1710/SteveAuroralArc_allskyproj960.jpg"
    },
    {
    "date": "2001-01-14",
    ...
    "hdurl": "https://apod.nasa.gov/apod/image/0312/doublecluster_fulbright_big.jpg",
    "media_type": "image",
    "service_version": "v1",
    "title": "NGC 869 & NGC 884: A Double Open Cluster",
    "url": "https://apod.nasa.gov/apod/image/0312/doublecluster_fulbright.jpg"
    },
    {
    "copyright": "Greg Polanski",
    "date": "2020-11-18",
    ...
    "hdurl": "https://apod.nasa.gov/apod/image/2011/DoubleCluster_Polanski_4560.jpg",
    "media_type": "image",
    "service_version": "v1",
